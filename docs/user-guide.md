...
- **Accept button** — Default: "Accept"
- **Reject button** — Default: "Reject"
- **"More info" button** — Default: "info..."
...
3. A floating cookie button appears so visitors can change their preference later
...
Make sure the popup appeared and was interacted with at least once. After that, a "Manage preferences" button appears at the bottom of every page. Clicking it re-opens the consent popup.
